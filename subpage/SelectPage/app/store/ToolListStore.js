...
Ext.define('NavigationApp.store.ToolListStore', {
    ...
    constructor: function(cfg) {
        ...
        cfg = cfg || {};
        var data = [
            ["OrbitDesignTool","卫星轨道交互设计工具","围绕科学目标，通过图形化、交互式手段快速构建目标轨道，并可根据用户需求即时进行修改。"],
            ...
            ["ArgumentionTaskTool","空间科学任务论证支持服务","支持6-10个科学家组的论证管理，支持每个论证项目的用户管理、数据存储与管理、流程制定与监控，工具调用。"],
