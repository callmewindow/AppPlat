 ...
 */
Ext.define('DataTransAnalysisApp.view.SchedulerView', {
    ...
    resourceStore: Ext.create('DataTransAnalysisApp.store.SchedulerResourceStore'),
    eventStore: Ext.create('DataTransAnalysisApp.store.SchedulerEventStore'),
