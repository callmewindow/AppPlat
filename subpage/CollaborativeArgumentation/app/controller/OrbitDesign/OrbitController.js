 ...
 */
Ext.define('AppPlat.controller.OrbitDesign.OrbitController', {
...
//            HoverText.refreshHovertextForPlanet();
    ...
    onOrbRespChg: function(button, e, eOpts){
        if(this.anglewindow == null||this.anglewindow == undefined){
            this.angleWindow = Ext.create('AppPlat.view.OrbitDesign.AngleWindow');
        }
...
//            ORBIT.camera.up.set(0, 0, 1);//设置摄像头的方向，哪个轴为1 摄像机就朝哪个轴的正方向拍；
    ...
    hideAndShowCombo:function(planet){
        var planetAxesCombo = this.getButtonGroupPanel().queryById('planetAxesCombo');
        var earthAxesCombo = this.getButtonGroupPanel().queryById('earthAxesCombo');
        var otherAxesCombo = this.getButtonGroupPanel().queryById('otherAxesCombo');
        switch (planet){
    ...
    changedSelectedPlanet:function(planetName){
        this.getButtonGroupPanel().queryById('angelMercury').setIconCls('mercury');
        this.getButtonGroupPanel().queryById('angelEarth').setIconCls('earth');
        this.getButtonGroupPanel().queryById('angelJupiter').setIconCls('jupiter');
        this.getButtonGroupPanel().queryById('angelMoon').setIconCls('moon');
        this.getButtonGroupPanel().queryById('angelNeptune').setIconCls('neptune');
        this.getButtonGroupPanel().queryById('angelSaturn').setIconCls('saturn');
        this.getButtonGroupPanel().queryById('angelSun').setIconCls('sun');
        this.getButtonGroupPanel().queryById('angelUranus').setIconCls('uranus');
        this.getButtonGroupPanel().queryById('angelVenus').setIconCls('venus');
        this.getButtonGroupPanel().queryById('angelMars').setIconCls('mars');
        switch(planetName){
            case 'mercury':this.getButtonGroupPanel().queryById('angelMercury').setIconCls('selectedmercury');break;
            case 'earth':  this.getButtonGroupPanel().queryById('angelEarth').setIconCls('selectedearth');break;
            case 'mars':   this.getButtonGroupPanel().queryById('angelMars').setIconCls('selectedmars');break;
            case 'moon':   this.getButtonGroupPanel().queryById('angelMoon').setIconCls('selectedmoon');break;
            case 'neptune':this.getButtonGroupPanel().queryById('angelNeptune').setIconCls('selectedneptune');break;
            case 'saturn': this.getButtonGroupPanel().queryById('angelSaturn').setIconCls('selectedsaturn');break;
            case 'sun':    this.getButtonGroupPanel().queryById('angelSun').setIconCls('selectedsun');break;
            case 'uranus': this.getButtonGroupPanel().queryById('angelUranus').setIconCls('selecteduranus');break;
            case 'venus':  this.getButtonGroupPanel().queryById('angelVenus').setIconCls('selectedvenus');break;
            case 'jupiter':  this.getButtonGroupPanel().queryById('angelJupiter').setIconCls('selectedjupiter');break;
        }
...
//            this.simuParawindow.queryById("stepLength").setValue(oldValue);
    ...
    onSimuParaClick: function(button, e, eOpts) {
        if(this.simuParawindow == null){
            this.simuParawindow = Ext.create('AppPlat.view.OrbitDesign.SimuParaWindow');
        }
    ...
    onSimuPLClick: function(button, e, eOpts){
        ...
        if(ORBIT.states_Simu){
            this.getButtonGroupPanel().queryById('simuPLBtn').setIconCls('stop');
            this.getButtonGroupPanel().queryById('simuPLBtn').setTooltip('暂停');
            this.getButtonGroupPanel().queryById('simuPLBtn').setText('暂停');
            ORBIT.simuPLBtn = this.getButtonGroupPanel().queryById('simuPLBtn');
            startOrbitSimu();
        }
        else{
            this.getButtonGroupPanel().queryById('simuPLBtn').setIconCls('start');
            this.getButtonGroupPanel().queryById('simuPLBtn').setTooltip('开始');
            this.getButtonGroupPanel().queryById('simuPLBtn').setText('开始');
        }
    },
